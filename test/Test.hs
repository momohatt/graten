...
exampleCases =
  ...
  , ("examples/gan/relativistic_dcgan_annotated.ml",         [],                                  1)
  , ("examples/jit/load_and_run.ml",                         [],                                  1)
  , ("examples/jit/load_and_run_annotated.ml",               [],                                  1)
  ...
  , ("examples/pretrained/predict_annotated.ml",             [],                                  2)
